...
from langchain_core.runnables import RunnableParallel,RunnableBranch,RunnableSequence
...
final_chain=RunnableSequence(temeplate1,model,parser,temeplate2,model,parser)
